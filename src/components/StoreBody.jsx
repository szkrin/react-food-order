...
export default function StoreBody() {
    ...
    const { isFetching, fetchedData, error, orderPlaced } = useContext(CartContext);
    ...
    return (
        <>
            ...
            {orderPlaced && <p className="text-4xl text-center text-yellow-500 font-bold">Order places succesfully!</p>}
